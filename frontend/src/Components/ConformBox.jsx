  ...
  return (
    <div className='fixed top-0 bottom-0 right-0 left-0 z-50 bg-neutral-800/70 p-4 flex justify-center items-center'>
        <div className='bg-white w-full max-w-md p-4 rounded'>
            ...
            <p className='text-sm my-4'>Are you sure to Permanently Delete?</p>
            <div className='w-fit ml-auto gap-3 flex items-center'>
                <button onClick={cancel} className='px-4 py-1 border rounded border-red-500 text-red-500 cursor-pointer hover:bg-red-500 hover:text-white'>Cancel</button>
